...
static void start_sync(SyncData *data) {
  data->context = g_main_context_new();
  data->loop = g_main_loop_new(data->context, FALSE);
  g_main_context_push_thread_default(data->context);
}

static void end_sync(SyncData *data) {
  if (data->loop != NULL)
    g_main_loop_run(data->loop);
  g_main_context_pop_thread_default(data->context);
}

static void sync_data_clear(SyncData *data) {
...
static void sync_cb(GObject *object, GAsyncResult *result, gpointer user_data) {
 ...
 * Since: 1.0
 */
gboolean snapd_client_connect_sync(SnapdClient *self, GCancellable *cancellable,
                                   GError **error) {
  return TRUE;
}
 ...
 */
SnapdAuthData *snapd_client_login_sync(SnapdClient *self, const gchar *email,
  ...
  snapd_client_login_async(self, email, password, otp, cancellable, sync_cb,
                           &data);
...
snapd_client_login2_sync(SnapdClient *self, const gchar *email,
                         const gchar *password, const gchar *otp,
  ...
  g_auto(SyncData) data = {0};
  start_sync(&data);
  snapd_client_login2_async(self, email, password, otp, cancellable, sync_cb,
                            &data);
  end_sync(&data);
 ...
 * Since: 1.55
 */
gboolean snapd_client_logout_sync(SnapdClient *self, gint64 id,
                                  GCancellable *cancellable, GError **error) {
 ...
 * Since: 1.29
 */
GPtrArray *snapd_client_get_changes_sync(SnapdClient *self,
  ...
  g_auto(SyncData) data = {0};
  start_sync(&data);
  snapd_client_get_changes_async(self, filter, snap_name, cancellable, sync_cb,
                                 &data);
  end_sync(&data);
 ...
 * Since: 1.29
 */
SnapdChange *snapd_client_get_change_sync(SnapdClient *self, const gchar *id,
                                          GCancellable *cancellable,
                                          GError **error) {
  g_return_val_if_fail(SNAPD_IS_CLIENT(self), NULL);
 ...
 * Since: 1.30
 */
SnapdChange *snapd_client_abort_change_sync(SnapdClient *self, const gchar *id,
                                            GCancellable *cancellable,
                                            GError **error) {
  g_return_val_if_fail(SNAPD_IS_CLIENT(self), NULL);
  g_return_val_if_fail(id != NULL, NULL);
...
SnapdSystemInformation *snapd_client_get_system_information_sync(
    SnapdClient *self, GCancellable *cancellable, GError **error) {
  g_return_val_if_fail(SNAPD_IS_CLIENT(self), NULL);
 ...
 */
SnapdSnap *snapd_client_list_one_sync(SnapdClient *self, const gchar *name,
                                      GCancellable *cancellable,
                                      GError **error) {
 ...
 * Since: 1.42
 */
SnapdSnap *snapd_client_get_snap_sync(SnapdClient *self, const gchar *name,
                                      GCancellable *cancellable,
                                      GError **error) {
  g_return_val_if_fail(SNAPD_IS_CLIENT(self), NULL);
 ...
 * Since: 1.48
 */
GHashTable *snapd_client_get_snap_conf_sync(SnapdClient *self,
                                            const gchar *name, GStrv keys,
                                            GCancellable *cancellable,
                                            GError **error) {
  g_return_val_if_fail(SNAPD_IS_CLIENT(self), NULL);
  ...
  g_auto(SyncData) data = {0};
  start_sync(&data);
  snapd_client_get_snap_conf_async(self, name, keys, cancellable, sync_cb,
                                   &data);
  end_sync(&data);
 ...
 * Since: 1.48
 */
gboolean snapd_client_set_snap_conf_sync(SnapdClient *self, const gchar *name,
  ...
  g_auto(SyncData) data = {0};
  start_sync(&data);
  snapd_client_set_snap_conf_async(self, name, key_values, cancellable, sync_cb,
                                   &data);
  end_sync(&data);
 ...
 */
GPtrArray *snapd_client_get_apps_sync(SnapdClient *self,
 ...
 * Since: 1.45
 */
GPtrArray *snapd_client_get_apps2_sync(SnapdClient *self,
                                       SnapdGetAppsFlags flags, GStrv snaps,
                                       GCancellable *cancellable,
                                       GError **error) {
  g_return_val_if_fail(SNAPD_IS_CLIENT(self), NULL);
 ...
 * Since: 1.0
 */
SnapdIcon *snapd_client_get_icon_sync(SnapdClient *self, const gchar *name,
                                      GCancellable *cancellable,
                                      GError **error) {
  g_return_val_if_fail(SNAPD_IS_CLIENT(self), NULL);
 ...
 */
GPtrArray *snapd_client_list_sync(SnapdClient *self, GCancellable *cancellable,
                                  GError **error) {
  g_return_val_if_fail(SNAPD_IS_CLIENT(self), NULL);
 ...
 * %SNAPD_SNAP_STATUS_ACTIVE). If @flags contains
 * %SNAPD_GET_SNAPS_FLAGS_INCLUDE_INACTIVE then also return snaps with status
 * %SNAPD_SNAP_STATUS_INSTALLED.
 *
 * If @flags contains %SNAPD_GET_SNAPS_FLAGS_REFRESH_INHIBITED, then it will
 ...
 * Since: 1.42
 */
GPtrArray *snapd_client_get_snaps_sync(SnapdClient *self,
 ...
 * Since: 1.8
 */
GStrv snapd_client_get_assertions_sync(SnapdClient *self, const gchar *type,
                                       GCancellable *cancellable,
                                       GError **error) {
  g_return_val_if_fail(SNAPD_IS_CLIENT(self), NULL);
 ...
 * Since: 1.8
 */
gboolean snapd_client_add_assertions_sync(SnapdClient *self, GStrv assertions,
                                          GCancellable *cancellable,
                                          GError **error) {
  g_return_val_if_fail(SNAPD_IS_CLIENT(self), FALSE);
  ...
  g_auto(SyncData) data = {0};
  start_sync(&data);
  snapd_client_add_assertions_async(self, assertions, cancellable, sync_cb,
                                    &data);
  end_sync(&data);
 ...
 */
gboolean snapd_client_get_interfaces_sync(SnapdClient *self, GPtrArray **plugs,
                                          GPtrArray **slots,
                                          GCancellable *cancellable,
                                          GError **error) {
  g_return_val_if_fail(SNAPD_IS_CLIENT(self), FALSE);
  ...
  end_sync(&data);
  G_GNUC_BEGIN_IGNORE_DEPRECATIONS
  return snapd_client_get_interfaces_finish(self, data.result, plugs, slots,
                                            error);
  G_GNUC_END_IGNORE_DEPRECATIONS
}
 ...
 *
 * Returns: (transfer container) (element-type SnapdInterface): the available
 * interfaces.
 *
 * Since: 1.48
 */
GPtrArray *snapd_client_get_interfaces2_sync(SnapdClient *self,
  ...
  g_auto(SyncData) data = {0};
  start_sync(&data);
  snapd_client_get_interfaces2_async(self, flags, names, cancellable, sync_cb,
                                     &data);
  end_sync(&data);
 ...
 */
gboolean snapd_client_get_connections_sync(SnapdClient *self,
  ...
  end_sync(&data);
  G_GNUC_BEGIN_IGNORE_DEPRECATIONS
  return snapd_client_get_connections_finish(self, data.result, established,
 ...
 * Since: 1.49
 */
gboolean snapd_client_get_connections2_sync(
    SnapdClient *self, SnapdGetConnectionsFlags flags, const gchar *snap,
    const gchar *interface, GPtrArray **established, GPtrArray **undesired,
    GPtrArray **plugs, GPtrArray **slots, GCancellable *cancellable,
    GError **error) {
  g_return_val_if_fail(SNAPD_IS_CLIENT(self), FALSE);

  g_auto(SyncData) data = {0};
  start_sync(&data);
  snapd_client_get_connections2_async(self, flags, snap, interface, cancellable,
                                      sync_cb, &data);
  end_sync(&data);
  return snapd_client_get_connections2_finish(self, data.result, established,
                                              undesired, plugs, slots, error);
}
...
gboolean snapd_client_connect_interface_sync(
  ...
  start_sync(&data);
  snapd_client_connect_interface_async(
      self, plug_snap, plug_name, slot_snap, slot_name, progress_callback,
      progress_callback_data, cancellable, sync_cb, &data);
  end_sync(&data);
 ...
 * Since: 1.0
 */
GPtrArray *snapd_client_find_sync(SnapdClient *self, SnapdFindFlags flags,
                                  const gchar *query,
                                  gchar **suggested_currency,
                                  GCancellable *cancellable, GError **error) {
  return snapd_client_find_category_sync(
      self, flags, NULL, query, suggested_currency, cancellable, error);
}
 ...
 */
GPtrArray *
snapd_client_find_section_sync(SnapdClient *self, SnapdFindFlags flags,
  ...
  start_sync(&data);
  G_GNUC_BEGIN_IGNORE_DEPRECATIONS
  snapd_client_find_section_async(self, flags, section, query, cancellable,
                                  sync_cb, &data);
  G_GNUC_END_IGNORE_DEPRECATIONS
  end_sync(&data);
  G_GNUC_BEGIN_IGNORE_DEPRECATIONS
  return snapd_client_find_section_finish(self, data.result, suggested_currency,
                                          error);
  G_GNUC_END_IGNORE_DEPRECATIONS
}
 ...
 */
GPtrArray *
snapd_client_find_category_sync(SnapdClient *self, SnapdFindFlags flags,
  ...
  g_auto(SyncData) data = {0};
  start_sync(&data);
  snapd_client_find_category_async(self, flags, category, query, cancellable,
                                   sync_cb, &data);
  end_sync(&data);
  return snapd_client_find_category_finish(self, data.result,
 ...
 * Since: 1.8
 */
GPtrArray *snapd_client_find_refreshable_sync(SnapdClient *self,
                                              GCancellable *cancellable,
                                              GError **error) {
  g_return_val_if_fail(SNAPD_IS_CLIENT(self), NULL);
 ...
 */
gboolean snapd_client_install_sync(SnapdClient *self, const gchar *name,
                                   const gchar *channel,
                                   SnapdProgressCallback progress_callback,
                                   gpointer progress_callback_data,
                                   GCancellable *cancellable, GError **error) {
  return snapd_client_install2_sync(self, SNAPD_INSTALL_FLAGS_NONE, name,
                                    channel, NULL, progress_callback,
                                    progress_callback_data, cancellable, error);
}
 ...
 * Since: 1.12
 */
gboolean snapd_client_install2_sync(SnapdClient *self, SnapdInstallFlags flags,
  ...
  g_auto(SyncData) data = {0};
  start_sync(&data);
  snapd_client_install2_async(self, flags, name, channel, revision,
                              progress_callback, progress_callback_data,
                              cancellable, sync_cb, &data);
  end_sync(&data);
...
gboolean snapd_client_install_stream_sync(
  ...
  g_auto(SyncData) data = {0};
  start_sync(&data);
  snapd_client_install_stream_async(self, flags, stream, progress_callback,
                                    progress_callback_data, cancellable,
                                    sync_cb, &data);
  end_sync(&data);
 ...
 * Since: 1.9
 */
gboolean snapd_client_try_sync(SnapdClient *self, const gchar *path,
                               SnapdProgressCallback progress_callback,
                               gpointer progress_callback_data,
                               GCancellable *cancellable, GError **error) {
  g_return_val_if_fail(SNAPD_IS_CLIENT(self), FALSE);
  ...
  g_auto(SyncData) data = {0};
  start_sync(&data);
  snapd_client_try_async(self, path, progress_callback, progress_callback_data,
                         cancellable, sync_cb, &data);
  end_sync(&data);
 ...
 * Since: 1.0
 */
gboolean snapd_client_refresh_sync(SnapdClient *self, const gchar *name,
                                   const gchar *channel,
                                   SnapdProgressCallback progress_callback,
                                   gpointer progress_callback_data,
                                   GCancellable *cancellable, GError **error) {
  ...
  g_auto(SyncData) data = {0};
  start_sync(&data);
  snapd_client_refresh_async(self, name, channel, progress_callback,
                             progress_callback_data, cancellable, sync_cb,
                             &data);
  end_sync(&data);
 ...
 * Since: 1.5
 */
GStrv snapd_client_refresh_all_sync(SnapdClient *self,
                                    SnapdProgressCallback progress_callback,
                                    gpointer progress_callback_data,
                                    GCancellable *cancellable, GError **error) {
  g_return_val_if_fail(SNAPD_IS_CLIENT(self), NULL);
  ...
  g_auto(SyncData) data = {0};
  start_sync(&data);
  snapd_client_refresh_all_async(self, progress_callback,
                                 progress_callback_data, cancellable, sync_cb,
                                 &data);
  end_sync(&data);
 ...
 */
gboolean snapd_client_remove_sync(SnapdClient *self, const gchar *name,
                                  SnapdProgressCallback progress_callback,
                                  gpointer progress_callback_data,
                                  GCancellable *cancellable, GError **error) {
  return snapd_client_remove2_sync(self, SNAPD_REMOVE_FLAGS_NONE, name,
                                   progress_callback, progress_callback_data,
                                   cancellable, error);
}
 ...
 * Since: 1.50
 */
gboolean snapd_client_remove2_sync(SnapdClient *self, SnapdRemoveFlags flags,
                                   const gchar *name,
                                   SnapdProgressCallback progress_callback,
                                   gpointer progress_callback_data,
                                   GCancellable *cancellable, GError **error) {
  ...
  g_auto(SyncData) data = {0};
  start_sync(&data);
  snapd_client_remove2_async(self, flags, name, progress_callback,
                             progress_callback_data, cancellable, sync_cb,
                             &data);
  end_sync(&data);
 ...
 * Since: 1.0
 */
gboolean snapd_client_enable_sync(SnapdClient *self, const gchar *name,
                                  SnapdProgressCallback progress_callback,
                                  gpointer progress_callback_data,
                                  GCancellable *cancellable, GError **error) {
  g_return_val_if_fail(SNAPD_IS_CLIENT(self), FALSE);
  ...
  g_auto(SyncData) data = {0};
  start_sync(&data);
  snapd_client_enable_async(self, name, progress_callback,
                            progress_callback_data, cancellable, sync_cb,
                            &data);
  end_sync(&data);
 ...
 * Since: 1.0
 */
gboolean snapd_client_disable_sync(SnapdClient *self, const gchar *name,
                                   SnapdProgressCallback progress_callback,
                                   gpointer progress_callback_data,
                                   GCancellable *cancellable, GError **error) {
  g_return_val_if_fail(SNAPD_IS_CLIENT(self), FALSE);
  ...
  g_auto(SyncData) data = {0};
  start_sync(&data);
  snapd_client_disable_async(self, name, progress_callback,
                             progress_callback_data, cancellable, sync_cb,
                             &data);
  end_sync(&data);
 ...
 * Since: 1.26
 */
gboolean snapd_client_switch_sync(SnapdClient *self, const gchar *name,
                                  const gchar *channel,
                                  SnapdProgressCallback progress_callback,
                                  gpointer progress_callback_data,
                                  GCancellable *cancellable, GError **error) {
  ...
  g_auto(SyncData) data = {0};
  start_sync(&data);
  snapd_client_switch_async(self, name, channel, progress_callback,
                            progress_callback_data, cancellable, sync_cb,
                            &data);
  end_sync(&data);
 ...
 * Since: 1.3
 */
gboolean snapd_client_check_buy_sync(SnapdClient *self,
                                     GCancellable *cancellable,
                                     GError **error) {
  g_return_val_if_fail(SNAPD_IS_CLIENT(self), FALSE);
 ...
 * Since: 1.3
 */
gboolean snapd_client_buy_sync(SnapdClient *self, const gchar *id,
                               gdouble amount, const gchar *currency,
                               GCancellable *cancellable, GError **error) {
  g_return_val_if_fail(SNAPD_IS_CLIENT(self), FALSE);
  ...
  g_auto(SyncData) data = {0};
  start_sync(&data);
  snapd_client_buy_async(self, id, amount, currency, cancellable, sync_cb,
                         &data);
  end_sync(&data);
 ...
 * Since: 1.3
 */
SnapdUserInformation *snapd_client_create_user_sync(SnapdClient *self,
                                                    const gchar *email,
  ...
  g_auto(SyncData) data = {0};
  start_sync(&data);
  snapd_client_create_user_async(self, email, flags, cancellable, sync_cb,
                                 &data);
  end_sync(&data);
 ...
 * Since: 1.3
 */
GPtrArray *snapd_client_create_users_sync(SnapdClient *self,
                                          GCancellable *cancellable,
                                          GError **error) {
  g_return_val_if_fail(SNAPD_IS_CLIENT(self), NULL);
 ...
 * Since: 1.26
 */
GPtrArray *snapd_client_get_users_sync(SnapdClient *self,
                                       GCancellable *cancellable,
                                       GError **error) {
  g_return_val_if_fail(SNAPD_IS_CLIENT(self), NULL);
 ...
 */
GStrv snapd_client_get_sections_sync(SnapdClient *self,
                                     GCancellable *cancellable,
                                     GError **error) {
  g_return_val_if_fail(SNAPD_IS_CLIENT(self), NULL);
 ...
 * Since: 1.64
 */
GPtrArray *snapd_client_get_categories_sync(SnapdClient *self,
                                            GCancellable *cancellable,
                                            GError **error) {
  g_return_val_if_fail(SNAPD_IS_CLIENT(self), NULL);
 ...
 * Since: 1.8
 */
GPtrArray *snapd_client_get_aliases_sync(SnapdClient *self,
                                         GCancellable *cancellable,
                                         GError **error) {
  g_return_val_if_fail(SNAPD_IS_CLIENT(self), NULL);
 ...
 * Since: 1.25
 */
gboolean snapd_client_alias_sync(SnapdClient *self, const gchar *snap,
  ...
  g_auto(SyncData) data = {0};
  start_sync(&data);
  snapd_client_alias_async(self, snap, app, alias, progress_callback,
                           progress_callback_data, cancellable, sync_cb, &data);
  end_sync(&data);
 ...
 * Since: 1.25
 */
gboolean snapd_client_unalias_sync(SnapdClient *self, const gchar *snap,
                                   const gchar *alias,
                                   SnapdProgressCallback progress_callback,
                                   gpointer progress_callback_data,
                                   GCancellable *cancellable, GError **error) {
  ...
  g_auto(SyncData) data = {0};
  start_sync(&data);
  snapd_client_unalias_async(self, snap, alias, progress_callback,
                             progress_callback_data, cancellable, sync_cb,
                             &data);
  end_sync(&data);
 ...
 * Since: 1.25
 */
gboolean snapd_client_prefer_sync(SnapdClient *self, const gchar *snap,
                                  SnapdProgressCallback progress_callback,
                                  gpointer progress_callback_data,
                                  GCancellable *cancellable, GError **error) {
  g_return_val_if_fail(SNAPD_IS_CLIENT(self), FALSE);
  ...
  g_auto(SyncData) data = {0};
  start_sync(&data);
  snapd_client_prefer_async(self, snap, progress_callback,
                            progress_callback_data, cancellable, sync_cb,
                            &data);
  end_sync(&data);
...
gboolean snapd_client_enable_aliases_sync(
    SnapdClient *self, const gchar *snap, GStrv aliases,
    SnapdProgressCallback progress_callback, gpointer progress_callback_data,
    GCancellable *cancellable, GError **error) {
 ...
 */
gboolean snapd_client_run_snapctl_sync(SnapdClient *self,
  ...
  start_sync(&data);
  G_GNUC_BEGIN_IGNORE_DEPRECATIONS
  snapd_client_run_snapctl_async(self, context_id, args, cancellable, sync_cb,
                                 &data);
  end_sync(&data);
  return snapd_client_run_snapctl_finish(self, data.result, stdout_output,
                                         stderr_output, error);
  G_GNUC_END_IGNORE_DEPRECATIONS
}
 ...
 * Since: 1.59
 */
gboolean snapd_client_run_snapctl2_sync(SnapdClient *self,
                                        const gchar *context_id, GStrv args,
                                        gchar **stdout_output,
  ...
  g_auto(SyncData) data = {0};
  start_sync(&data);
  snapd_client_run_snapctl2_async(self, context_id, args, cancellable, sync_cb,
                                  &data);
  end_sync(&data);
  return snapd_client_run_snapctl2_finish(self, data.result, stdout_output,
                                          stderr_output, exit_code, error);
}
 ...
 * Since: 1.54
 */
GBytes *snapd_client_download_sync(SnapdClient *self, const gchar *name,
  ...
  g_auto(SyncData) data = {0};
  start_sync(&data);
  snapd_client_download_async(self, name, channel, revision, cancellable,
                              sync_cb, &data);
  end_sync(&data);
 ...
 * Since: 1.60
 */
gboolean snapd_client_check_themes_sync(
    SnapdClient *self, GStrv gtk_theme_names, GStrv icon_theme_names,
    GStrv sound_theme_names, GHashTable **gtk_theme_status,
    GHashTable **icon_theme_status, GHashTable **sound_theme_status,
    GCancellable *cancellable, GError **error) {
  g_return_val_if_fail(SNAPD_IS_CLIENT(self), FALSE);

  g_auto(SyncData) data = {0};
  start_sync(&data);
  snapd_client_check_themes_async(self, gtk_theme_names, icon_theme_names,
                                  sound_theme_names, cancellable, sync_cb,
                                  &data);
  end_sync(&data);
  return snapd_client_check_themes_finish(self, data.result, gtk_theme_status,
                                          icon_theme_status, sound_theme_status,
                                          error);
}
 ...
 * Since: 1.60
 */
gboolean snapd_client_install_themes_sync(
    SnapdClient *self, GStrv gtk_theme_names, GStrv icon_theme_names,
  ...
  snapd_client_install_themes_async(
      self, gtk_theme_names, icon_theme_names, sound_theme_names,
      progress_callback, progress_callback_data, cancellable, sync_cb, &data);
  end_sync(&data);
 ...
 * Since: 1.64
 */
GPtrArray *snapd_client_get_logs_sync(SnapdClient *self, GStrv names, size_t n,
                                      GCancellable *cancellable,
                                      GError **error) {
  g_return_val_if_fail(SNAPD_IS_CLIENT(self), NULL);
 ...
 * Since: 1.64
 */
gboolean snapd_client_follow_logs_sync(SnapdClient *self, GStrv names,
  ...
  g_auto(SyncData) data = {0};
  start_sync(&data);
  snapd_client_follow_logs_async(self, names, log_callback, log_callback_data,
                                 cancellable, sync_cb, &data);
  end_sync(&data);
 ...
 * Since: 1.65
 */
GPtrArray *snapd_client_get_notices_sync(SnapdClient *self,
  ...
  g_auto(SyncData) data = {0};
  start_sync(&data);
  snapd_client_get_notices_async(self, since_date_time, timeout, cancellable,
                                 sync_cb, &data);
  end_sync(&data);
 ...
 * Since: 1.65
 */
GPtrArray *snapd_client_get_notices_with_filters_sync(
 ...
 * Since: 1.67
 */
gchar *snapd_client_get_model_assertion_sync(SnapdClient *self,
                                             GCancellable *cancellable,
                                             GError **error) {
  g_return_val_if_fail(SNAPD_IS_CLIENT(self), NULL);
 ...
 * Since: 1.67
 */
gchar *snapd_client_get_serial_assertion_sync(SnapdClient *self,
                                              GCancellable *cancellable,
                                              GError **error) {
  g_return_val_if_fail(SNAPD_IS_CLIENT(self), NULL);
