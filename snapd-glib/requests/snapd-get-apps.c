...
SnapdGetApps *_snapd_get_apps_new(GStrv snaps, GCancellable *cancellable,
                                  ...
                                  gpointer user_data) {
  SnapdGetApps *self = SNAPD_GET_APPS(g_object_new(
      snapd_get_apps_get_type(), "cancellable", cancellable, "ready-callback",
...
void _snapd_get_apps_set_select(SnapdGetApps *self, const gchar *select) {
  g_free(self->select);
  self->select = g_strdup(select);
}

GPtrArray *_snapd_get_apps_get_apps(SnapdGetApps *self) { return self->apps; }

static SoupMessage *generate_get_apps_request(SnapdRequest *request,
                                              GBytes **body) {
...
static gboolean parse_get_apps_response(SnapdRequest *request,
                                        guint status_code,
...
static void snapd_get_apps_finalize(GObject *object) {
...
static void snapd_get_apps_class_init(SnapdGetAppsClass *klass) {
...
static void snapd_get_apps_init(SnapdGetApps *self) {}
