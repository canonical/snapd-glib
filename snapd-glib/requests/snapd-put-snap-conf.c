...
G_DEFINE_TYPE(SnapdPutSnapConf, snapd_put_snap_conf,
...
static SoupMessage *generate_put_snap_conf_request(SnapdRequest *request,
                                                   GBytes **body) {
...
static void snapd_put_snap_conf_finalize(GObject *object) {
...
static void snapd_put_snap_conf_class_init(SnapdPutSnapConfClass *klass) {
...
static void snapd_put_snap_conf_init(SnapdPutSnapConf *self) {}
