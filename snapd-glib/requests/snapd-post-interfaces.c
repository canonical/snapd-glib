...
G_DEFINE_TYPE(SnapdPostInterfaces, snapd_post_interfaces,
...
SnapdPostInterfaces *_snapd_post_interfaces_new(
    ...
    gpointer user_data) {
  SnapdPostInterfaces *self = SNAPD_POST_INTERFACES(
      g_object_new(snapd_post_interfaces_get_type(), "cancellable", cancellable,
...
static SoupMessage *generate_post_interfaces_request(SnapdRequest *request,
                                                     GBytes **body) {
...
static void snapd_post_interfaces_finalize(GObject *object) {
...
static void snapd_post_interfaces_class_init(SnapdPostInterfacesClass *klass) {
...
static void snapd_post_interfaces_init(SnapdPostInterfaces *self) {}
