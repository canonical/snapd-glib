...
SnapdGetSnap *_snapd_get_snap_new(const gchar *name, GCancellable *cancellable,
                                  ...
                                  gpointer user_data) {
  SnapdGetSnap *self = SNAPD_GET_SNAP(g_object_new(
      snapd_get_snap_get_type(), "cancellable", cancellable, "ready-callback",
...
SnapdSnap *_snapd_get_snap_get_snap(SnapdGetSnap *self) { return self->snap; }
...
static void snapd_get_snap_finalize(GObject *object) {
...
static void snapd_get_snap_class_init(SnapdGetSnapClass *klass) {
...
static void snapd_get_snap_init(SnapdGetSnap *self) {}
