...
enum { PROP_AMOUNT = 1, PROP_CURRENCY, PROP_LAST };
 ...
 * Since: 1.0
 */
gdouble snapd_price_get_amount(SnapdPrice *self) {
 ...
 * Since: 1.0
 */
const gchar *snapd_price_get_currency(SnapdPrice *self) {
  g_return_val_if_fail(SNAPD_IS_PRICE(self), NULL);
  return self->currency;
}

static void snapd_price_set_property(GObject *object, guint prop_id,
...
static void snapd_price_get_property(GObject *object, guint prop_id,
...
static void snapd_price_finalize(GObject *object) {
  SnapdPrice *self = SNAPD_PRICE(object);
...
static void snapd_price_class_init(SnapdPriceClass *klass) {
