 ...
 * Since: 1.26
 */
gint64 snapd_user_information_get_id(SnapdUserInformation *self) {
 ...
 * Since: 1.3
 */
const gchar *snapd_user_information_get_username(SnapdUserInformation *self) {
 ...
 * Since: 1.26
 */
const gchar *snapd_user_information_get_email(SnapdUserInformation *self) {
  g_return_val_if_fail(SNAPD_IS_USER_INFORMATION(self), NULL);
  return self->email;
}
 ...
 * Since: 1.3
 */
GStrv snapd_user_information_get_ssh_keys(SnapdUserInformation *self) {
  g_return_val_if_fail(SNAPD_IS_USER_INFORMATION(self), NULL);
...
static void snapd_user_information_set_property(GObject *object, guint prop_id,
                                                const GValue *value,
                                                GParamSpec *pspec) {
...
static void snapd_user_information_get_property(GObject *object, guint prop_id,
                                                GValue *value,
                                                GParamSpec *pspec) {
  SnapdUserInformation *self = SNAPD_USER_INFORMATION(object);
...
static void snapd_user_information_finalize(GObject *object) {
  SnapdUserInformation *self = SNAPD_USER_INFORMATION(object);
