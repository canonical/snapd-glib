 ...
 * Since: 1.65
 */
const gchar *snapd_notice_get_id(SnapdNotice *self) {
 ...
 * Since: 1.65
 */
const gchar *snapd_notice_get_user_id(SnapdNotice *self) {
  g_return_val_if_fail(SNAPD_IS_NOTICE(self), NULL);
  return self->userid;
}
 ...
 */
GHashTable *snapd_notice_get_last_data(SnapdNotice *self) {
  g_return_val_if_fail(SNAPD_IS_NOTICE(self), NULL);
 ...
 */
GDateTime *snapd_notice_get_first_occurred(SnapdNotice *self) {
  g_return_val_if_fail(SNAPD_IS_NOTICE(self), NULL);
 ...
 * Since: 1.66
 */
GDateTime *snapd_notice_get_first_occurred2(SnapdNotice *self) {
  g_return_val_if_fail(SNAPD_IS_NOTICE(self), NULL);
 ...
 */
GDateTime *snapd_notice_get_last_occurred(SnapdNotice *self) {
  g_return_val_if_fail(SNAPD_IS_NOTICE(self), NULL);
 ...
 * Since: 1.66
 */
GDateTime *snapd_notice_get_last_occurred2(SnapdNotice *self) {
  g_return_val_if_fail(SNAPD_IS_NOTICE(self), NULL);
 ...
 * Since: 1.66
 */
int snapd_notice_get_last_occurred_nanoseconds(SnapdNotice *self) {
 ...
 */
GDateTime *snapd_notice_get_last_repeated(SnapdNotice *self) {
  g_return_val_if_fail(SNAPD_IS_NOTICE(self), NULL);
 ...
 * Since: 1.66
 */
GDateTime *snapd_notice_get_last_repeated2(SnapdNotice *self) {
  g_return_val_if_fail(SNAPD_IS_NOTICE(self), NULL);
 ...
 * Since: 1.65
 */
gint64 snapd_notice_get_occurrences(SnapdNotice *self) {
  g_return_val_if_fail(SNAPD_IS_NOTICE(self), 0);
 ...
 * Since: 1.65
 */
GTimeSpan snapd_notice_get_repeat_after(SnapdNotice *self) {
  g_return_val_if_fail(SNAPD_IS_NOTICE(self), 0);
 ...
 * Since: 1.65
 */
GTimeSpan snapd_notice_get_expire_after(SnapdNotice *self) {
  g_return_val_if_fail(SNAPD_IS_NOTICE(self), 0);
 ...
 * Since: 1.66
 */
gint snapd_notice_compare_last_occurred(SnapdNotice *self,
  ...
  if (notice_nano == -1)
    notice_nano =
        1000 * g_date_time_get_microsecond(notice_to_compare->last_occurred);
...
static void snapd_notice_set_property(GObject *object, guint prop_id,
  ...
  case PROP_LAST_OCCURRED:
    ...
    if (g_value_get_boxed(value) != NULL) {
      ...
      self->last_occurred_internal =
          g_date_time_add(self->last_occurred,
...
static void snapd_notice_get_property(GObject *object, guint prop_id,
...
static void snapd_notice_finalize(GObject *object) {
  SnapdNotice *self = SNAPD_NOTICE(object);
...
static void snapd_notice_class_init(SnapdNoticeClass *klass) {
