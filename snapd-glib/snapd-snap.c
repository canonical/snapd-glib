 ...
 * Since: 1.0
 */
GPtrArray *snapd_snap_get_apps(SnapdSnap *self) {
 ...
 * Since: 1.45
 */
const gchar *snapd_snap_get_base(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
  return self->base;
}
 ...
 * Since: 1.25
 */
const gchar *snapd_snap_get_broken(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
  return self->broken;
}
 ...
 * Since: 1.64
 */
GPtrArray *snapd_snap_get_categories(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
 ...
 * Since: 1.0
 */
const gchar *snapd_snap_get_channel(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
  return self->channel;
}
 ...
 * Since: 1.22
 */
GPtrArray *snapd_snap_get_channels(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
  return self->channels;
}

static int parse_risk(const gchar *risk) {
 ...
 * Since: 1.22
 */
SnapdChannel *snapd_snap_match_channel(SnapdSnap *self, const gchar *name) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
  ...
  for (guint i = 0; i < self->channels->len; i++) {
    ...
    if (g_strcmp0(snapd_channel_get_track(channel),
                  snapd_channel_get_track(c)) != 0 ||
        g_strcmp0(snapd_channel_get_branch(channel),
                  snapd_channel_get_branch(c)) != 0)
      continue;
 ...
 * Since: 1.41
 */
GStrv snapd_snap_get_common_ids(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
 ...
 * Since: 1.0
 */
SnapdConfinement snapd_snap_get_confinement(SnapdSnap *self) {
 ...
 * Since: 1.13
 */
const gchar *snapd_snap_get_contact(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
  return self->contact;
}
 ...
 * Since: 1.0
 */
const gchar *snapd_snap_get_description(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
 ...
 */
const gchar *snapd_snap_get_developer(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
 ...
 * Since: 1.0
 */
gboolean snapd_snap_get_devmode(SnapdSnap *self) {
 ...
 * Since: 1.0
 */
gint64 snapd_snap_get_download_size(SnapdSnap *self) {
 ...
 * Since: 1.64
 */
GDateTime *snapd_snap_get_hold(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
  return self->hold;
}
 ...
 * Since: 1.65
 */
GDateTime *snapd_snap_get_proceed_time(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
 ...
 * Since: 1.0
 */
const gchar *snapd_snap_get_icon(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
  return self->icon;
}
 ...
 * Since: 1.0
 */
const gchar *snapd_snap_get_id(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
  return self->id;
}
 ...
 * Since: 1.0
 */
GDateTime *snapd_snap_get_install_date(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
 ...
 * Since: 1.0
 */
gint64 snapd_snap_get_installed_size(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), 0);
 ...
 * Since: 1.8
 */
gboolean snapd_snap_get_jailmode(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), FALSE);
 ...
 * Since: 1.19
 */
const gchar *snapd_snap_get_license(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
  return self->license;
}
 ...
 * Since: 1.45
 */
GPtrArray *snapd_snap_get_media(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
  return self->media;
}
 ...
 * Since: 1.45
 */
const gchar *snapd_snap_get_mounted_from(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
 ...
 * Since: 1.14
 */
const gchar *snapd_snap_get_title(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
  return self->title;
}
 ...
 * Since: 1.0
 */
const gchar *snapd_snap_get_name(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
  return self->name;
}
 ...
 * Since: 1.0
 */
GPtrArray *snapd_snap_get_prices(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
  return self->prices;
}
 ...
 * Since: 1.0
 */
gboolean snapd_snap_get_private(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), FALSE);
  return self->private;
}
 ...
 * Since: 1.42
 */
const gchar *snapd_snap_get_publisher_display_name(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
 ...
 * Since: 1.42
 */
const gchar *snapd_snap_get_publisher_id(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
 ...
 * Since: 1.42
 */
const gchar *snapd_snap_get_publisher_username(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
  return self->publisher_username;
}
 ...
 * Since: 1.42
 */
SnapdPublisherValidation snapd_snap_get_publisher_validation(SnapdSnap *self) {
 ...
 * Since: 1.0
 */
const gchar *snapd_snap_get_revision(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
 ...
 */
GPtrArray *snapd_snap_get_screenshots(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
 ...
 * Since: 1.0
 */
SnapdSnapType snapd_snap_get_snap_type(SnapdSnap *self) {
 ...
 * Since: 1.0
 */
SnapdSnapStatus snapd_snap_get_status(SnapdSnap *self) {
 ...
 * Since: 1.60
 */
const gchar *snapd_snap_get_store_url(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
 ...
 * Since: 1.0
 */
const gchar *snapd_snap_get_summary(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
  return self->summary;
}
 ...
 * Since: 1.7
 */
const gchar *snapd_snap_get_tracking_channel(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
 ...
 *
 * Returns: (transfer none) (array zero-terminated=1): an ordered array of track
 * names.
 *
 * Since: 1.22
 */
GStrv snapd_snap_get_tracks(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
  return self->tracks;
}
 ...
 * Since: 1.0
 */
gboolean snapd_snap_get_trymode(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), FALSE);
  return self->trymode;
}
 ...
 * Since: 1.0
 */
const gchar *snapd_snap_get_version(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
  return self->version;
}
 ...
 * Since: 1.50
 */
const gchar *snapd_snap_get_website(SnapdSnap *self) {
  g_return_val_if_fail(SNAPD_IS_SNAP(self), NULL);
  return self->website;
}

static void snapd_snap_set_property(GObject *object, guint prop_id,
...
static void snapd_snap_get_property(GObject *object, guint prop_id,
...
static void snapd_snap_finalize(GObject *object) {
  SnapdSnap *self = SNAPD_SNAP(object);
...
static void snapd_snap_class_init(SnapdSnapClass *klass) {
