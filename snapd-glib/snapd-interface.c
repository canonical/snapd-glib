 ...
 */
gchar *
snapd_interface_make_label (SnapdInterface *self)
{
    if (strcmp (self->name, "account-control") == 0)
        ...
        return g_strdup (_("Detect network devices using mDNS/DNS-SD (Bonjour/zeroconf)"));
        ...
        return g_strdup (_("Access the NetworkManager service to read and change network settings"));
        ...
        return g_strdup (_("Access the ofono service to read and change network settings for mobile telephony"));
        ...
        return g_strdup (_("Access pppd and ppp devices for configuring Point-to-Point Protocol connections"));
        ...
        return g_strdup (_("Access the UDisks2 service for configuring disks and removable media"));
