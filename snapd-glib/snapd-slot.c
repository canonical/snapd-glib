 ...
 * Since: 1.0
 */
const gchar *snapd_slot_get_name(SnapdSlot *self) {
 ...
 * Since: 1.0
 */
const gchar *snapd_slot_get_snap(SnapdSlot *self) {
  g_return_val_if_fail(SNAPD_IS_SLOT(self), NULL);
  return self->snap;
}
 ...
 * Since: 1.0
 */
const gchar *snapd_slot_get_interface(SnapdSlot *self) {
  g_return_val_if_fail(SNAPD_IS_SLOT(self), NULL);
 ...
 * Since: 1.3
 */
GStrv snapd_slot_get_attribute_names(SnapdSlot *self, guint *length) {
  g_return_val_if_fail(SNAPD_IS_SLOT(self), NULL);
 ...
 * Since: 1.3
 */
gboolean snapd_slot_has_attribute(SnapdSlot *self, const gchar *name) {
 ...
 * Since: 1.3
 */
GVariant *snapd_slot_get_attribute(SnapdSlot *self, const gchar *name) {
  g_return_val_if_fail(SNAPD_IS_SLOT(self), NULL);
 ...
 * Since: 1.0
 */
const gchar *snapd_slot_get_label(SnapdSlot *self) {
  g_return_val_if_fail(SNAPD_IS_SLOT(self), NULL);
  return self->label;
}
 ...
 */
GPtrArray *snapd_slot_get_connections(SnapdSlot *self) {
  g_return_val_if_fail(SNAPD_IS_SLOT(self), NULL);
 ...
 * Since: 1.48
 */
GPtrArray *snapd_slot_get_connected_plugs(SnapdSlot *self) {
  g_return_val_if_fail(SNAPD_IS_SLOT(self), NULL);
  return self->connections;
}

static void snapd_slot_set_property(GObject *object, guint prop_id,
...
static void snapd_slot_get_property(GObject *object, guint prop_id,
...
static void snapd_slot_finalize(GObject *object) {
  SnapdSlot *self = SNAPD_SLOT(object);
...
static void snapd_slot_class_init(SnapdSlotClass *klass) {
