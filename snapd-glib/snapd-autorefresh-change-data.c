...
G_DEFINE_TYPE (SnapdAutorefreshChangeData, snapd_autorefresh_change_data, SNAPD_TYPE_CHANGE_DATA)
...
static void
snapd_autorefresh_change_data_set_property (GObject *object, guint prop_id, const GValue *value, GParamSpec *pspec)
{
...
static void
snapd_autorefresh_change_data_get_property (GObject *object, guint prop_id, GValue *value, GParamSpec *pspec)
{
    SnapdAutorefreshChangeData *self = SNAPD_AUTOREFRESH_CHANGE_DATA (object);
...
static void
snapd_autorefresh_change_data_finalize (GObject *object)
{
    SnapdAutorefreshChangeData *self = SNAPD_AUTOREFRESH_CHANGE_DATA (object);
...
static void
snapd_autorefresh_change_data_class_init (SnapdAutorefreshChangeDataClass *klass)
{
