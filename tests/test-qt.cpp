...
static void test_socket_closed_before_request() {
...
static void test_socket_closed_after_request() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
static void test_user_agent_default() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_user_agent_custom() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_user_agent_null() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_accept_language() {
...
static void test_accept_language_empty() {
  g_setenv("LANG", "", TRUE);
...
static void test_allow_interaction() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_maintenance_none() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_maintenance_daemon_restart() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
static void test_maintenance_system_restart() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
static void test_maintenance_unknown() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
static void test_get_system_information_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  ...
  g_assert_true(systemInformation->refreshNext() ==
...
void GetSystemInformationHandler::onComplete() {
...
static void test_get_system_information_async() {
  ...
  QObject::connect(infoHandler.request,
                   &QSnapdGetSystemInformationRequest::complete, &infoHandler,
...
static void test_get_system_information_store() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
static void test_get_system_information_refresh() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  mock_snapd_set_refresh_timer(snapd, "00:00~24:00/4");
  ...
  g_assert_true(systemInformation->refreshSchedule().isNull());
  g_assert_true(systemInformation->refreshTimer() == "00:00~24:00/4");
  g_assert_true(systemInformation->refreshHold() ==
                QDateTime(QDate(2018, 1, 20), QTime(1, 2, 3), Qt::UTC));
  g_assert_true(systemInformation->refreshLast() ==
                QDateTime(QDate(2018, 1, 19), QTime(1, 2, 3), Qt::UTC));
  g_assert_true(systemInformation->refreshNext() ==
                QDateTime(QDate(2018, 1, 19), QTime(13, 14, 15), Qt::UTC));
}

static void test_get_system_information_refresh_schedule() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
static void test_get_system_information_confinement_strict() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
static void test_login_invalid_email() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_login_invalid_password() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  mock_snapd_add_account(snapd, "test@example.com", "test", "secret");
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_login_otp_missing() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockAccount *a =
      mock_snapd_add_account(snapd, "test@example.com", "test", "secret");
...
static void test_login_otp_invalid() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockAccount *a =
      mock_snapd_add_account(snapd, "test@example.com", "test", "secret");
  mock_account_set_otp(a, "1234");
...
static void test_get_changes_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  ...
  g_assert_true(change0->spawnTime() ==
                QDateTime(QDate(2017, 1, 2), QTime(11, 0, 0), Qt::UTC));
  g_assert_true(change0->readyTime() ==
  ...
  g_assert_true(task0->spawnTime() ==
                QDateTime(QDate(2017, 1, 2), QTime(11, 0, 0), Qt::UTC));
  g_assert_true(task0->readyTime() ==
  ...
  g_assert_true(task1->spawnTime() ==
                QDateTime(QDate(2017, 1, 2), QTime(11, 0, 10), Qt::UTC));
  g_assert_true(task1->readyTime() ==
                QDateTime(QDate(2017, 1, 2), QTime(11, 0, 30), Qt::UTC));
  ...
  g_assert_true(change1->spawnTime() ==
  ...
  g_assert_true(task->spawnTime() ==
                QDateTime(QDate(2017, 1, 2), QTime(11, 15, 0), Qt::UTC));
  g_assert_false(task->readyTime().isValid());
}

void GetChangesHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
...
static void test_get_changes_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
  ...
  QObject::connect(changesHandler.request, &QSnapdGetChangesRequest::complete,
                   &changesHandler, &GetChangesHandler::onComplete);
  changesHandler.request->runAsync();

  g_main_loop_run(loop);
}

static void test_get_changes_filter_in_progress() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
static void test_get_changes_filter_ready() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
static void test_get_changes_filter_snap() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
static void test_get_changes_filter_ready_snap() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
static void test_get_changes_data() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
static void test_get_change_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  ...
  g_assert_true(change->spawnTime() ==
                QDateTime(QDate(2017, 1, 2), QTime(11, 0, 0), Qt::UTC));
  g_assert_true(change->readyTime() ==
                QDateTime(QDate(2017, 1, 2), QTime(11, 0, 30), Qt::UTC));
...
void GetChangeHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
...
static void test_logout_no_auth() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  mock_snapd_add_account(snapd, "test1@example.com", "test1", "secret");
  MockAccount *a =
      mock_snapd_add_account(snapd, "test2@example.com", "test2", "secret");
...
static void test_get_change_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
...
static void test_abort_change_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
void AbortChangeHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
...
static void test_abort_change_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
  ...
  QObject::connect(abortHandler.request, &QSnapdAbortChangeRequest::complete,
                   &abortHandler, &AbortChangeHandler::onComplete);
  abortHandler.request->runAsync();

  g_main_loop_run(loop);
}

static void test_list_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
static void test_get_snaps_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap1");
  mock_snap_set_status(s, "installed");
  mock_snapd_add_snap(snapd, "snap1");
...
void GetSnapsHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
  g_assert_cmpint(request->snapCount(), ==, 3);
  QScopedPointer<QSnapdSnap> snap0(request->snap(0));
  g_assert_true(snap0->name() == "snap1");
...
static void test_get_snaps_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
  ...
  QObject::connect(getSnapsHandler.request, &QSnapdGetSnapsRequest::complete,
                   &getSnapsHandler, &GetSnapsHandler::onComplete);
  getSnapsHandler.request->runAsync();

  g_main_loop_run(loop);
}

static void test_get_snaps_filter() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap1");
  mock_snap_set_status(s, "installed");
  mock_snapd_add_snap(snapd, "snap1");
  ...
  QScopedPointer<QSnapdGetSnapsRequest> getSnapsRequest(
      client.getSnaps(QSnapdClient::IncludeInactive, QStringList("snap1")));
  getSnapsRequest->runSync();
  g_assert_cmpint(getSnapsRequest->error(), ==, QSnapdRequest::NoError);
...
static void test_list_one_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
void ListOneHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
...
static void test_list_one_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
...
static void test_get_snap_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  mock_snapd_add_snap(snapd, "snap");
  g_assert_true(mock_snapd_start(snapd, NULL));
...
void GetSnapHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
  QScopedPointer<QSnapdSnap> snap(request->snap());
  g_assert_cmpint(snap->appCount(), ==, 0);
  g_assert_null(snap->base());
...
static void test_get_snap_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
...
static void test_get_snap_types() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
static void test_get_snap_deprecated_fields() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  mock_snapd_add_snap(snapd, "snap");
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_get_snap_common_ids() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap");
...
static void test_get_snap_not_installed() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_get_snap_classic_confinement() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap");
  mock_snap_set_confinement(s, "classic");
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_get_snap_devmode_confinement() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap");
...
static void test_get_snap_daemons() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap");
  MockApp *a = mock_snap_add_app(s, "app1");
...
static void test_get_snap_publisher_starred() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap");
...
static void test_get_snap_publisher_verified() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap");
...
static void test_get_snap_publisher_unproven() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap");
...
static void test_get_snap_publisher_unknown_validation() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap");
...
static void check_get_snap_conf_result(QSnapdGetSnapConfRequest &request) {
...
static void test_get_snap_conf_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
void GetSnapConfHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
...
static void test_get_snap_conf_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
...
static void test_get_snap_conf_key_filter() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "core");
  mock_snap_set_conf(s, "string-key", "\"value\"");
  mock_snap_set_conf(s, "int-key", "42");
...
static void test_get_snap_conf_invalid_key() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "core");
  mock_snap_set_conf(s, "string-key", "\"value\"");
  mock_snap_set_conf(s, "int-key", "42");
...
static QHash<QString, QVariant> setup_set_snap_conf(MockSnapd *snapd) {
...
static void test_set_snap_conf_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
void SetSnapConfHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
...
static void test_set_snap_conf_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
...
static void test_set_snap_conf_invalid() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  mock_snapd_add_snap(snapd, "core");
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_get_apps_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap");
  MockApp *a = mock_snap_add_app(s, "app1");
  a = mock_snap_add_app(s, "app2");
...
void GetAppsHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
...
static void test_get_apps_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
...
static void test_get_apps_services() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap");
...
static void test_get_apps_filter() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap1");
  mock_snap_add_app(s, "app1");
...
void GetIconHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
...
static void test_icon_not_installed() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_get_assertions_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
static void test_get_assertions_body() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  mock_snapd_add_assertion(snapd, "type: account\n"
                                  "body-length: 4\n"
                                  "\n"
...
static void test_get_assertions_multiple() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  mock_snapd_add_assertion(snapd, "type: account\n"
                                  "\n"
                                  "SIGNATURE1\n"
...
static void test_get_assertions_invalid() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_add_assertions_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_assertions_sync() {
...
static void test_assertions_body() {
  QSnapdAssertion assertion("type: account\n"
                            "body-length: 4\n"
                            "\n"
                            "BODY\n"
...
static void check_plug_no_attributes(QSnapdPlug &plug) {
  QStringList attribute_names = plug.attributeNames();
  g_assert_cmpint(attribute_names.length(), ==, 0);
}

static void check_slot_no_attributes(QSnapdSlot &slot) {
  QStringList attribute_names = slot.attributeNames();
  g_assert_cmpint(attribute_names.length(), ==, 0);
}

static void check_connection_no_plug_attributes(QSnapdConnection &connection) {
  g_assert_cmpint(connection.plugAttributeNames().length(), ==, 0);
}

static void check_connection_no_slot_attributes(QSnapdConnection &connection) {
  g_assert_cmpint(connection.slotAttributeNames().length(), ==, 0);
}

static void check_get_connections_result(QSnapdGetConnectionsRequest &request,
                                         bool selectAll) {
...
static void test_get_connections_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
void GetConnectionsHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
...
static void test_get_connections_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
  ...
  QObject::connect(getConnectionsHandler.request,
                   &QSnapdGetConnectionsRequest::complete,
...
static void test_get_connections_empty() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_get_connections_filter_all() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  setup_get_connections(snapd);
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_get_connections_filter_snap() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockInterface *i = mock_snapd_add_interface(snapd, "interface");
...
static void test_get_connections_filter_interface() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
static void check_names_match(QStringList names, QStringList &expected_names) {
...
static void test_get_connections_attributes() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockInterface *i = mock_snapd_add_interface(snapd, "interface");
  MockSnap *s = mock_snapd_add_snap(snapd, "snap1");
  MockSlot *sl = mock_snap_add_slot(s, i, "slot1");
  ...
  g_assert_true(connection->plugAttribute("plug-number-key").type() ==
                QMetaType::Double);
  g_assert_cmpfloat(connection->plugAttribute("plug-number-key").toDouble(), ==,
                    1.25);
  ...
  g_assert_true(connection->slotAttribute("slot-number-key").type() ==
                QMetaType::Double);
  g_assert_cmpfloat(connection->slotAttribute("slot-number-key").toDouble(), ==,
                    1.25);
...
static void check_get_interfaces_result(QSnapdGetInterfacesRequest &request) {
...
static void test_get_interfaces_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
void GetInterfacesHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
...
static void test_get_interfaces_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
  ...
  QObject::connect(getInterfacesHandler.request,
                   &QSnapdGetInterfacesRequest::complete, &getInterfacesHandler,
...
static void test_get_interfaces_no_snaps() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_get_interfaces_attributes() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockInterface *i = mock_snapd_add_interface(snapd, "interface");
  MockSnap *s = mock_snapd_add_snap(snapd, "snap1");
  MockSlot *sl = mock_snap_add_slot(s, i, "slot1");
  ...
  check_names_match(plug->attributeNames(), QStringList() << "plug-string-key"
                                                          << "plug-int-key"
                                                          << "plug-bool-key");
  g_assert_true(plug->hasAttribute("plug-string-key"));
  g_assert_true(plug->attribute("plug-string-key").type() ==
  ...
  check_names_match(slot->attributeNames(), QStringList() << "slot-string-key"
                                                          << "slot-int-key"
                                                          << "slot-bool-key");
  g_assert_true(slot->hasAttribute("slot-string-key"));
  g_assert_true(slot->attribute("slot-string-key").type() ==
...
static void test_get_interfaces_legacy() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockInterface *i = mock_snapd_add_interface(snapd, "interface");
  MockSnap *s = mock_snapd_add_snap(snapd, "snap1");
  MockSlot *sl = mock_snap_add_slot(s, i, "slot1");
...
static void test_get_interfaces2_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockInterface *i1 = mock_snapd_add_interface(snapd, "interface1");
...
void GetInterfaces2Handler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
...
static void test_get_interfaces2_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
  ...
  QObject::connect(getInterfacesHandler.request,
                   &QSnapdGetInterfaces2Request::complete,
...
static void test_get_interfaces2_only_connected() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
static void test_get_interfaces2_slots() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockInterface *i = mock_snapd_add_interface(snapd, "interface");
  MockSnap *s = mock_snapd_add_snap(snapd, "snap1");
...
static void test_get_interfaces2_plugs() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockInterface *i = mock_snapd_add_interface(snapd, "interface");
  MockSnap *s = mock_snapd_add_snap(snapd, "snap1");
  mock_snap_add_slot(s, i, "slot1");
...
static void test_get_interfaces2_filter() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
static void test_get_interfaces2_make_label() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
static void test_connect_interface_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockInterface *i = mock_snapd_add_interface(snapd, "interface");
  MockSnap *s = mock_snapd_add_snap(snapd, "snap1");
...
void ConnectInterfaceHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
  MockSlot *slot =
...
static void test_connect_interface_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
  ...
  ConnectInterfaceHandler connectInterfaceHandler(
      loop, snapd, client.connectInterface("snap2", "plug", "snap1", "slot"));
  QObject::connect(
      connectInterfaceHandler.request, &QSnapdConnectInterfaceRequest::complete,
      &connectInterfaceHandler, &ConnectInterfaceHandler::onComplete);
  connectInterfaceHandler.request->runAsync();

  g_main_loop_run(loop);
}

static void test_connect_interface_progress() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockInterface *i = mock_snapd_add_interface(snapd, "interface");
  MockSnap *s = mock_snapd_add_snap(snapd, "snap1");
  MockSlot *slot = mock_snap_add_slot(s, i, "slot");
  ...
  QObject::connect(connectInterfaceRequest.data(), SIGNAL(progress()), &counter,
                   SLOT(progress()));
  connectInterfaceRequest->runSync();
  g_assert_cmpint(connectInterfaceRequest->error(), ==, QSnapdRequest::NoError);
  g_assert_true(mock_snapd_find_plug_connection(snapd, plug) == slot);
...
static void test_connect_interface_invalid() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_disconnect_interface_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockInterface *i = mock_snapd_add_interface(snapd, "interface");
  MockSnap *s = mock_snapd_add_snap(snapd, "snap1");
  MockSlot *slot = mock_snap_add_slot(s, i, "slot");
  ...
  QScopedPointer<QSnapdDisconnectInterfaceRequest> disconnectInterfaceRequest(
...
void DisconnectInterfaceHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
...
static void test_disconnect_interface_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
...
static void test_disconnect_interface_progress() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockInterface *i = mock_snapd_add_interface(snapd, "interface");
  MockSnap *s = mock_snapd_add_snap(snapd, "snap1");
  MockSlot *slot = mock_snap_add_slot(s, i, "slot");
...
static void test_disconnect_interface_invalid() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_find_query() {
  ...
  g_strv_builder_add(contact_url_builder, "contact");
  ...
  g_strv_builder_add(website_url_builder, "website");
...
static void test_find_query_private() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockAccount *a =
      mock_snapd_add_account(snapd, "test@example.com", "test", "secret");
...
static void test_find_query_private_not_logged_in() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_find_bad_query() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_find_network_timeout() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_find_dns_failure() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_find_name_private() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockAccount *a =
      mock_snapd_add_account(snapd, "test@example.com", "test", "secret");
...
static void test_find_name_private_not_logged_in() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_find_channels() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
static void test_find_channels_match() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
static gboolean find_cancel_cb(QSnapdFindRequest *request) {
  request->cancel();
  return G_SOURCE_REMOVE;
}

void FindHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::Cancelled);
  g_main_loop_quit(loop);
}

static void test_find_cancel() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
...
static void test_find_section_query() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_store_snap(snapd, "apple");
  mock_snap_add_store_category(s, "section", FALSE);
  mock_snapd_add_store_snap(snapd, "banana");
...
static void test_find_section_name() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_store_snap(snapd, "apple");
  mock_snap_add_store_category(s, "section", FALSE);
  mock_snapd_add_store_snap(snapd, "banana");
...
static void test_find_category() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_store_snap(snapd, "apple");
...
static void test_find_category_query() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_store_snap(snapd, "apple");
  mock_snap_add_store_category(s, "category", FALSE);
  mock_snapd_add_store_snap(snapd, "banana");
...
static void test_find_category_name() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_store_snap(snapd, "apple");
  mock_snap_add_store_category(s, "category", FALSE);
  mock_snapd_add_store_snap(snapd, "banana");
...
static void test_find_scope_narrow() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
static void test_find_scope_wide() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_store_snap(snapd, "snap1");
  s = mock_snapd_add_store_snap(snapd, "snap2");
  mock_snap_set_scope_is_wide(s, TRUE);
...
static void test_find_common_id() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_store_snap(snapd, "snap1");
...
static void test_find_refreshable_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap1");
...
void FindRefreshableHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
...
static void test_find_refreshable_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
  ...
  QObject::connect(
      findRefreshableHandler.request, &QSnapdFindRefreshableRequest::complete,
      &findRefreshableHandler, &FindRefreshableHandler::onComplete);
  findRefreshableHandler.request->runAsync();

  g_main_loop_run(loop);
}

static void test_find_refreshable_no_updates() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_install_sync_multiple() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  mock_snapd_add_store_snap(snapd, "snap1");
  mock_snapd_add_store_snap(snapd, "snap2");
  mock_snapd_add_store_snap(snapd, "snap3");
...
void InstallHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
  g_assert_nonnull(mock_snapd_find_snap(snapd, "snap"));
  g_assert_cmpstr(
      mock_snap_get_confinement(mock_snapd_find_snap(snapd, "snap")), ==,
...
static void test_install_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
...
void InstallMultipleHandler::onComplete() {
...
static void test_install_async_multiple() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
  ...
  QSnapdInstallRequest *request;
  foreach (request, requests) {
    QObject::connect(request, &QSnapdInstallRequest::complete, &installHandler,
...
void InstallErrorHandler::onComplete() {
...
static void test_install_async_failure() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
...
static gboolean install_cancel_cb(QSnapdInstallRequest *request) {
  request->cancel();
  return G_SOURCE_REMOVE;
}

void InstallCancelHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::Cancelled);
  g_assert_null(mock_snapd_find_snap(snapd, "snap"));
...
static void test_install_async_cancel() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
...
void InstallMultipleCancelFirstHandler::checkComplete() {
  counter++;
  if (counter == requests.size()) {
    g_assert_null(mock_snapd_find_snap(snapd, "snap1"));
    g_assert_nonnull(mock_snapd_find_snap(snapd, "snap2"));
...
void InstallMultipleCancelFirstHandler::onCompleteSnap1() {
  g_assert_cmpint(requests[0]->error(), ==, QSnapdRequest::Cancelled);
  checkComplete();
}

void InstallMultipleCancelFirstHandler::onCompleteSnap2() {
  g_assert_cmpint(requests[1]->error(), ==, QSnapdRequest::NoError);
  checkComplete();
}

void InstallMultipleCancelFirstHandler::onCompleteSnap3() {
  g_assert_cmpint(requests[2]->error(), ==, QSnapdRequest::NoError);
  checkComplete();
}

static void test_install_async_multiple_cancel_first() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
...
void InstallMultipleCancelLastHandler::checkComplete() {
  counter++;
  if (counter == requests.size()) {
    g_assert_nonnull(mock_snapd_find_snap(snapd, "snap1"));
    g_assert_nonnull(mock_snapd_find_snap(snapd, "snap2"));
...
void InstallMultipleCancelLastHandler::onCompleteSnap1() {
  g_assert_cmpint(requests[0]->error(), ==, QSnapdRequest::NoError);
  checkComplete();
}

void InstallMultipleCancelLastHandler::onCompleteSnap2() {
  g_assert_cmpint(requests[1]->error(), ==, QSnapdRequest::NoError);
  checkComplete();
}

void InstallMultipleCancelLastHandler::onCompleteSnap3() {
  g_assert_cmpint(requests[2]->error(), ==, QSnapdRequest::Cancelled);
  checkComplete();
}

static void test_install_async_multiple_cancel_last() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
...
static void test_install_progress() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  mock_snapd_add_store_snap(snapd, "snap");
  g_assert_true(mock_snapd_start(snapd, NULL));
  ...
  mock_snapd_set_spawn_time(
      snapd, counter.spawnTime.toString(Qt::ISODate).toStdString().c_str());
  mock_snapd_set_ready_time(
      snapd, counter.readyTime.toString(Qt::ISODate).toStdString().c_str());
...
static void test_install_needs_classic() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_store_snap(snapd, "snap");
  mock_snap_set_confinement(s, "classic");
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_install_classic() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  mock_snapd_set_on_classic(snapd, TRUE);
  MockSnap *s = mock_snapd_add_store_snap(snapd, "snap");
  mock_snap_set_confinement(s, "classic");
...
static void test_install_not_classic() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  mock_snapd_set_on_classic(snapd, TRUE);
  mock_snapd_add_store_snap(snapd, "snap");
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_install_needs_classic_system() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_store_snap(snapd, "snap");
  mock_snap_set_confinement(s, "classic");
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_install_needs_devmode() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_store_snap(snapd, "snap");
  mock_snap_set_confinement(s, "devmode");
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_install_devmode() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_store_snap(snapd, "snap");
  mock_snap_set_confinement(s, "devmode");
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_install_dangerous() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  mock_snapd_add_store_snap(snapd, "snap");
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_install_jailmode() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  mock_snapd_add_store_snap(snapd, "snap");
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_install_channel() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_store_snap(snapd, "snap");
...
static void test_install_revision() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_store_snap(snapd, "snap");
...
static void test_install_not_available() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_install_channel_not_available() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  mock_snapd_add_store_snap(snapd, "snap");
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_install_revision_not_available() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  mock_snapd_add_store_snap(snapd, "snap");
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_install_snapd_restart() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_store_snap(snapd, "snap");
...
static void test_install_async_snapd_restart() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
...
static void test_install_auth_cancelled() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  mock_snapd_add_store_snap(snapd, "snap");
...
static void test_install_stream_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  mock_snapd_add_store_snap(snapd, "snap");
  g_assert_true(mock_snapd_start(snapd, NULL));
...
void InstallStreamHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
  MockSnap *snap = mock_snapd_find_snap(snapd, "sideload");
  g_assert_nonnull(snap);
  g_assert_cmpstr(mock_snap_get_data(snap), ==, "SNAP");
...
static void test_install_stream_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
...
static void test_install_stream_progress() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  mock_snapd_add_store_snap(snapd, "snap");
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_install_stream_classic() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  mock_snapd_add_store_snap(snapd, "snap");
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_install_stream_dangerous() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  mock_snapd_add_store_snap(snapd, "snap");
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_install_stream_devmode() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  mock_snapd_add_store_snap(snapd, "snap");
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_install_stream_jailmode() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  mock_snapd_add_store_snap(snapd, "snap");
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_try_async() {
  ...
  QObject::connect(tryHandler.request, &QSnapdTryRequest::complete, &tryHandler,
                   &TryHandler::onComplete);
  tryHandler.request->runAsync();
}

static void test_try_progress() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_try_not_a_snap() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
void RefreshHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);

  g_main_loop_quit(loop);
}

static void test_refresh_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
...
static void test_refresh_progress() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap");
  mock_snap_set_revision(s, "0");
  s = mock_snapd_add_store_snap(snapd, "snap");
...
static void test_refresh_channel() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap");
  mock_snap_set_revision(s, "0");
  s = mock_snapd_add_store_snap(snapd, "snap");
...
static void test_refresh_no_updates() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap");
  mock_snap_set_revision(s, "0");
  s = mock_snapd_add_store_snap(snapd, "snap");
...
static void test_refresh_not_installed() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_refresh_not_in_store() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap");
  mock_snap_set_revision(s, "0");
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_refresh_all_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap1");
  mock_snap_set_revision(s, "0");
  s = mock_snapd_add_snap(snapd, "snap2");
...
void RefreshAllHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
...
static void test_refresh_all_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
...
static void test_refresh_all_progress() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap1");
  mock_snap_set_revision(s, "0");
  s = mock_snapd_add_snap(snapd, "snap2");
  ...
  QScopedPointer<QSnapdRefreshAllRequest> refreshAllRequest(
      client.refreshAll());
  ProgressCounter counter;
  QObject::connect(refreshAllRequest.data(), SIGNAL(progress()), &counter,
                   SLOT(progress()));
  refreshAllRequest->runSync();
  g_assert_cmpint(refreshAllRequest->error(), ==, QSnapdRequest::NoError);
  g_assert_cmpint(refreshAllRequest->snapNames().count(), ==, 2);
...
static void test_refresh_all_no_updates() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
void RemoveErrorHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::Failed);
  g_assert_true(request->errorString() == "ERROR");
  g_assert_nonnull(mock_snapd_find_snap(snapd, "snap"));
...
static void test_remove_async_failure() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
...
static gboolean remove_cancel_cb(QSnapdRemoveRequest *request) {
  request->cancel();
  return G_SOURCE_REMOVE;
}

void RemoveCancelHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::Cancelled);
  g_assert_nonnull(mock_snapd_find_snap(snapd, "snap"));
...
static void test_remove_async_cancel() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
...
static void test_remove_progress() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  mock_snapd_add_snap(snapd, "snap");
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_remove_not_installed() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_enable_progress() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap");
  mock_snap_set_disabled(s, TRUE);
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_enable_already_enabled() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap");
...
static void test_enable_not_installed() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
void DisableHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
  g_assert_true(mock_snap_get_disabled(mock_snapd_find_snap(snapd, "snap")));
...
static void test_disable_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
...
static void test_disable_progress() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap");
  mock_snap_set_disabled(s, FALSE);
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_disable_already_disabled() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap");
  mock_snap_set_disabled(s, TRUE);
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_disable_not_installed() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
void SwitchChannelHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
  g_assert_cmpstr(
      mock_snap_get_tracking_channel(mock_snapd_find_snap(snapd, "snap")), ==,
      "beta");
...
static void test_switch_async() {
  ...
  SwitchChannelHandler switchHandler(loop, snapd,
                                     client.switchChannel("snap", "beta"));
  QObject::connect(switchHandler.request, &QSnapdSwitchChannelRequest::complete,
                   &switchHandler, &SwitchChannelHandler::onComplete);
  switchHandler.request->runAsync();
  g_main_loop_run(loop);
}

static void test_switch_progress() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap");
  mock_snap_set_tracking_channel(s, "stable");
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_switch_not_installed() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_check_buy_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockAccount *a =
      mock_snapd_add_account(snapd, "test@example.com", "test", "secret");
...
void CheckBuyHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);

  g_main_loop_quit(loop);
}

static void test_check_buy_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
  ...
  QObject::connect(checkBuyHandler.request, &QSnapdCheckBuyRequest::complete,
                   &checkBuyHandler, &CheckBuyHandler::onComplete);
  checkBuyHandler.request->runAsync();
  g_main_loop_run(loop);
}

static void test_check_buy_terms_not_accepted() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockAccount *a =
      mock_snapd_add_account(snapd, "test@example.com", "test", "secret");
...
static void test_check_buy_no_payment_methods() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockAccount *a =
      mock_snapd_add_account(snapd, "test@example.com", "test", "secret");
  mock_account_set_terms_accepted(a, TRUE);
...
static void test_check_buy_not_logged_in() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
void BuyHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);

  g_main_loop_quit(loop);
}

static void test_buy_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
  ...
  QObject::connect(buyHandler.request, &QSnapdBuyRequest::complete, &buyHandler,
                   &BuyHandler::onComplete);
  buyHandler.request->runAsync();
  g_main_loop_run(loop);
}

static void test_buy_not_logged_in() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_store_snap(snapd, "snap");
  mock_snap_set_id(s, "ABCDEF");
  mock_snap_add_price(s, 1.25, "NZD");
...
static void test_buy_not_available() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockAccount *a =
      mock_snapd_add_account(snapd, "test@example.com", "test", "secret");
  mock_account_set_terms_accepted(a, TRUE);
...
static void test_buy_terms_not_accepted() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockAccount *a =
      mock_snapd_add_account(snapd, "test@example.com", "test", "secret");
  mock_account_set_terms_accepted(a, FALSE);
...
static void test_buy_no_payment_methods() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockAccount *a =
      mock_snapd_add_account(snapd, "test@example.com", "test", "secret");
  mock_account_set_terms_accepted(a, TRUE);
...
static void test_buy_invalid_price() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockAccount *a =
      mock_snapd_add_account(snapd, "test@example.com", "test", "secret");
  mock_account_set_terms_accepted(a, TRUE);
...
static void test_create_user_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_create_user_sudo() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_create_user_known() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_create_users_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_get_users_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
void GetUsersHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
...
static void test_get_users_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
  ...
  QObject::connect(getUsersHandler.request, &QSnapdGetUsersRequest::complete,
                   &getUsersHandler, &GetUsersHandler::onComplete);
  getUsersHandler.request->runAsync();
  g_main_loop_run(loop);
}

static void test_get_sections_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
void GetSectionsHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
...
static void test_get_sections_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
...
static void test_get_categories_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
void GetCategoriesHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
...
static void test_get_categories_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
  ...
  QT_WARNING_POP
  QObject::connect(getCategoriesHandler.request,
                   &QSnapdGetCategoriesRequest::complete, &getCategoriesHandler,
                   &GetCategoriesHandler::onComplete);
  getCategoriesHandler.request->runAsync();
  g_main_loop_run(loop);
}

static void test_aliases_get_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap");
  MockApp *a = mock_snap_add_app(s, "app");
  ...
  std::sort(aliases.begin(), aliases.end(), [](QSnapdAlias *a, QSnapdAlias *b) {
...
void GetAliasesHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
...
static void test_aliases_get_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
...
static void test_aliases_get_empty() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_aliases_alias_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap");
  MockApp *a = mock_snap_add_app(s, "app");
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_aliases_alias_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
...
static void test_aliases_unalias_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap");
  MockApp *a = mock_snap_add_app(s, "app");
...
void UnaliasHandler::onComplete() {
  MockSnap *s = mock_snapd_find_snap(snapd, "snap");
  MockApp *a = mock_snap_find_app(s, "app");
...
static void test_aliases_unalias_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
...
static void test_aliases_unalias_no_snap_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap");
  MockApp *a = mock_snap_add_app(s, "app");
  mock_app_add_manual_alias(a, "foo", TRUE);
...
static void test_aliases_prefer_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  MockSnap *s = mock_snapd_add_snap(snapd, "snap");
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_aliases_prefer_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
...
static void test_run_snapctl_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_run_snapctl_unsuccessful() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
  ...
  QScopedPointer<QSnapdRunSnapCtlRequest> runSnapCtlRequest(
      client.runSnapCtl("return-error", QStringList() << "arg1" << "arg2"));
  runSnapCtlRequest->runSync();
  g_assert_cmpint(runSnapCtlRequest->error(), ==, QSnapdRequest::NoError);
...
void RunSnapCtlHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
...
static void test_run_snapctl_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
...
static void test_download_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
void DownloadHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
...
static void test_download_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
  ...
  QObject::connect(downloadHandler.request, &QSnapdDownloadRequest::complete,
                   &downloadHandler, &DownloadHandler::onComplete);
  downloadHandler.request->runAsync();
  g_main_loop_run(loop);
}

static void test_download_channel_revision() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  g_assert_true(mock_snapd_start(snapd, NULL));
...
static void test_themes_check_sync(void) {
  ...
  QScopedPointer<QSnapdCheckThemesRequest> checkThemesRequest(
      client.checkThemes(
          ...
          QStringList() << "soundtheme1" << "soundtheme2" << "soundtheme3"));
...
void CheckThemesHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
...
static void test_themes_install_async(void) {
  ...
  InstallThemesHandler installThemesHandler(
      ...
      client.installThemes(QStringList("gtktheme1"), QStringList("icontheme1"),
                           QStringList("soundtheme1")));
  QObject::connect(installThemesHandler.request,
                   &QSnapdInstallThemesRequest::complete, &installThemesHandler,
...
static void test_themes_install_progress(void) {
  ...
  QScopedPointer<QSnapdInstallThemesRequest> installThemesRequest(
      client.installThemes(QStringList("gtktheme1"), QStringList("icontheme1"),
                           QStringList()));
  ProgressCounter counter;
  QObject::connect(installThemesRequest.data(), SIGNAL(progress()), &counter,
                   SLOT(progress()));
  installThemesRequest->runSync();
  g_assert_cmpint(installThemesRequest->error(), ==, QSnapdRequest::NoError);
  g_assert_cmpint(counter.progressDone, >, 0);
...
static void test_notices_events() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
...
static void test_get_notices_after_notice() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  ...
  noticesRequest->setSinceDateFilterFromDateNanoseconds(
      QDateTime::fromString("2023-02-05T21:23:03.123456789+01:32", Qt::ISODate),
      123456789);
  noticesRequest->runSync();
...
static void test_get_model_assertion_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  ...
  QScopedPointer<QSnapdGetModelAssertionRequest> modelAssertionRequest(
      client.getModelAssertion());
  modelAssertionRequest->runSync();
  g_assert_cmpint(modelAssertionRequest->error(), ==, QSnapdRequest::NoError);
  g_assert_true(modelAssertionRequest->modelAssertion() ==
                "type: model\n\nSIGNATURE");
}

void GetModelAssertionHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
...
static void test_get_model_assertion_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
  ...
  GetModelAssertionHandler getModelAssertionHandler(loop,
                                                    client.getModelAssertion());
  QObject::connect(getModelAssertionHandler.request,
                   &QSnapdGetModelAssertionRequest::complete,
...
static void test_get_serial_assertion_sync() {
  g_autoptr(MockSnapd) snapd = mock_snapd_new();
  ...
  QScopedPointer<QSnapdGetSerialAssertionRequest> serialAssertionRequest(
      client.getSerialAssertion());
  serialAssertionRequest->runSync();
  g_assert_cmpint(serialAssertionRequest->error(), ==, QSnapdRequest::NoError);
  g_assert_true(serialAssertionRequest->serialAssertion() ==
                "type: serial\n\nSIGNATURE");
}

void GetSerialAssertionHandler::onComplete() {
  g_assert_cmpint(request->error(), ==, QSnapdRequest::NoError);
...
static void test_get_serial_assertion_async() {
  g_autoptr(GMainLoop) loop = g_main_loop_new(NULL, FALSE);
  ...
  GetSerialAssertionHandler getSerialAssertionHandler(
      loop, client.getSerialAssertion());
  QObject::connect(getSerialAssertionHandler.request,
                   &QSnapdGetSerialAssertionRequest::complete,
